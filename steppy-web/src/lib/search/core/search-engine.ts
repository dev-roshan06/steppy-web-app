...
export class SearchEngine {
	 ...
	 * Uses exact phrase, token, synonym, and fuzzy matching to score and rank results.
	 */
	 ...
	 * Supports synonym expansion and fuzzy matching; optionally searches inside step text.
	 */
